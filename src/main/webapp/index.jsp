...
<body>
    ...
    <script src="jfileupload/s/jquery.fileupload-process.js"></script>
    ...
    <script src="jfileupload/s/jquery.fileupload-video.js"></script>
    ...
    <script src="fileupload/js/demo.js"></script>
